...
<html lang="en">
    <head>
        ...
        <title>Mentee Eligibility | Mentoree</title>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <?php
                ...
                $menteeList = $menteedao->retrieveUncheckedMentees();
                if ($menteeList == []){
                    echo "<div class='col'>No mentees to be checked</div>";
                    } else {
                    $i = 0;
                    foreach($menteeList as $mentee){
                        $email = $mentee->getEmail();
                        $name = $mentee->getFirstName() . ' ' . $mentee->getLastName();
                        $profilePath = $mentee->getProfilePath();
                        $whyJoin = $mentee->getWhyJoin();
                        ...
                        echo "<div class='col mb-4' style='padding-top: 30px;'>
                                <div class='card h-100'>
                                    ...
                                    <div class='card-footer'>
                                        ...
                                        <button type='submit' class='btn btn-primary' name='Accept' value='A$i'>Eligible</button>                  
                                        <button type='submit' class='btn btn-primary' name='Accept' value='R$i'>Not Eligible</button>
                                    </div>
                                </div>
                            </div>";
                        $i++;
            ...
            <?php
                ...
                $email = $_POST["$i"];
                if ($result == 'R') {
                    $menteedao->deleteMentee($email);
                }
                else {
                    $menteedao->updateCheckedYet($email);
                }
