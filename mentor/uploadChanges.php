...
if (sizeof($errors) == 0) {
    if ($mentordao->update($email, $profilePath, $phoneNum, $whyChooseMe)) {
        $_SESSION['user'] = $mentordao->retrieveMentor($email);
    ...
    echo "</ul>
          ...
          Go back to <a href=mentorProfile.php>Profile</a> page
          </div>";
}
