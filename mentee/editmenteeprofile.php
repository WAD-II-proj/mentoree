	...
	<body>
		...
		<!-- <div class="container-fluid"> -->
            ...
            <div class="col-4 mx-auto">
                ...
                <form action="uploadChangesMentee.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row my-2">
                        ...
                        <div class="custom-file xs">
                            <input type="file" name="profileImg" id="profileImg"> 
                        </div>
                        <small id="passwordHelpInline" class="text-muted mb-2">
                        Please name your file in the following format:<br>e.g. if your email is xxx@gmail.com, name your file as xxx.png or xxx.jpg
                        </small>
                    </div>

                    <button class="btn btn-primary my-3" type="submit" name="submit" value="editmentee">Save Changes</button>
